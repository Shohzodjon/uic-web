    ...
    >
      ...
      <div class="flex items-center gap-10 pt-2 md:pt-6">
        <div class="flex items-center gap-3">
          ...
          <p v-if="blog?.date" class="text-[#A5A5A6] font-['Roboto'] leading-[19px] font-medium">
            <!-- {{ blog?.date }} -->
...
const wholeTime = computed(() => eachBlog.mainBlogId?.current_blog?.date);
const socialLinks = [
  {
    icon: "facebook_share",
...
onMounted(() => {
  eachBlog.fetchEachBlog(router.currentRoute._rawValue.params.slug).then(() => {

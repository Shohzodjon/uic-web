  ...
  <div class="main-block" id="main-block">
    ...
    >
      <div class="hero-info md:max-w-[506px] w-full">
        ...
        >
          <!-- font-sofia  -->
          <router-link class="" :to="{ name: 'PPortfolio' }">
    ...
    <div class="main-block__background">
      ...
      <span class="mountain" id="mountain">
        <img src="/uic-images/mountain.webp" alt="" />
  ...
  <transition name="fade">
    ...
    >
      <div class="relative flex items-center justify-center w-full h-full">
        <button
          class="text-white absolute top-[15%] right-[5%] sm:right-[5%] md:top-[15%] md:right-[10%] lg:right-[17%] text-base"
          @click="closeModal"
        >
          <u-icons name="close_icon" class="close--icon" />
        </button>
        <div
          class="w-[85%] h-[300px] sm:w-[80%] md:w-[70%] lg:w-[60%] xl:w-[50%]"
        >
          <iframe
            v-if="showModal"
            width="100%"

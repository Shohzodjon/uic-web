<template>
  <section class="overflow-hidden">
    ...
    <!-- begin copy -->
    <div
      class="portfolio-section bg-[#141415] pt-8 sm:pt-[60px] md:pt-[129px] pb-[96px]"
    >
      <div class="container">
        <div
          class="md:flex items-center justify-between text-[#fff] mb-[65px]"
          data-aos="fade-right"
          data-aos-duration="600"
        >
          <div class="container-video">
            <div class="overflow-hidden h-[55px]">
          ...
          <div
            class="flex md:justify-end gap-[16px] max-w-[660px] md:mt-0 mt-[50px]"
          >
            <div class="flex gap-2 md:gap-4 sm:gap-2">
              <router-link
        ...
        <div class="md:w-[180px] sm:w-[140px] w-[122px] !h-[48px]">
          <white-button
            ...
            v-bind="{
              title: 'services.all',
              link: '/portfolio',
              customClass: 'rounded-8 whitespace-nowrap',
            }"
            :cards="portfolioImg"
            :small="true"
            class="mt-8 index-portfolio !rounded-[8px]"
          />
        </div>
      </div>
    </div>
...
const portfolioCategory = computed(() => categoryStore.mainCategories?.results);
onMounted(() => {
...
const serviceCard = ref([
  ...
  // TODO:joyiga quyish
  //  TODO: translate qilish kerak pastini
  {

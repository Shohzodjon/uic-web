<template>
  ...
  <div class="container pt-[130px]">
    <div class="container-video">
      ...
      <p class="text font-bold uppercase text-[64px] text-[#fff]">portfolio</p>
    </div>

    <div
      :data-aos-duration="500"
      class="flex flex-wrap gap-[16px] md:gap-[24px] items-center duration-300 card-tabs mb-9 mt-11"
      data-aos="fade-right"
    >
      <span
...
onMounted(() => {
  portfolioStore.fetchMainPortfolioImg().then(() => {
    globalStore.openLoad(loading);
  });
  portfolioStore.fetchPortfolioCategories().then(() => {
    globalStore.openLoad(loading);
  });

  ...
  >
    ...
    >
      ...
      <transition name="closeBtn">
        <button class="text-white inline-flex lg:!hidden" @click="closeBtn">
          <u-icons
      ...
      <nav>
        ...
        >
          ...
          <ul
            ...
            class="items-center hidden gap-0 duration-300 menu__body lg:flex md:gap-5 lg:gap-6 xl:gap-12"
          >
            ...
            <li v-if="mainPage">
              <a
                ...
                :href="`tel:${$t('header_tel1') + $t('header_tel2')}`"
              >
                {{ $t("header_tel1") }}
          ...
          <LanguageSelect
            ...
            v-bind="{ title: activeItem.short, data: { results: langs } }"
      ...
      >
        ...
        <a
          ...
          @click="positionMenu = false"
          target="_blank"
          ><span class="text-[#ffffff94]">{{ $t("company_tel") }} </span>
        </a>
      </div>
    </div>
  </header>

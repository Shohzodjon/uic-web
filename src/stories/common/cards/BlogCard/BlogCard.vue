<template>
  <router-link :to="slug">
    <div
      class="ml-[15px] bg-blog-card-background grid grid-cols-12 sm:px-0 px-4 rounded-8 group hover:transition hover:ease-in-out hover:duration-500"
    >
      <div class="sm:col-span-5 col-span-12 sm:-mt-0 -mt-[70px] mr-3 h-[210px]">
        <div
      ...
      <div class="col-span-12 py-4 pr-0 sm:py-5.5 sm:pr-7 sm:col-span-7">
        <WordHighlighter
          :query="searchQuery"
        ...
        <WordHighlighter
          :query="searchQuery"
          highlight-class="!text-white !bg-[#00A795]"
